...
const Header = () => {
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-primary">
      ...
      <div className="relative flex flex-col md:flex-row items-stretch px-5 sm:px-10 lg:px-16 pt-8 sm:pt-10 md:pt-14">
        {/* ── Left: copy ── */}
        <div className="md:w-1/2 flex flex-col justify-center text-white pb-8 md:pb-16 z-10">
          <h1 className="text-[1.65rem] leading-[1.1] sm:text-4xl lg:text-5xl font-extrabold tracking-tight">
            Book Appointment{" "}
          ...
          <p className="mt-4 max-w-md text-sm sm:text-base text-white/90 leading-relaxed">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-2.5 sm:gap-3">
            <a
              href="#speciality"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 px-6 py-3 rounded-full bg-white text-gray-900 font-semibold shadow-lg hover:bg-gray-50 active:scale-[0.98] transition-all duration-200"
            >
              Book Appointment
            ...
            <button
              ...
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm !text-white font-semibold ring-2 ring-white/50 hover:bg-white/20 active:scale-[0.98] transition-all duration-200"
            >
          ...
          <div className="mt-6 sm:mt-8 flex flex-wrap items-center gap-x-5 gap-y-3">
            <div className="flex items-center gap-3">
              <img src={assets.group_profiles} alt="" className="h-8 sm:h-9 w-auto" />
        ...
        <div className="md:w-1/2 relative flex justify-center md:justify-end items-end">
          <img
            ...
            alt=""
            className="w-full max-w-[260px] sm:max-w-sm md:max-w-md h-auto md:absolute md:bottom-0 md:right-0"
          />
        </div>
      </div>
    </section>
