      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="p-6 sm:p-10 lg:p-12">
          ...
          <h2 className="mt-4 text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">
            ...
            <span className="inline-flex items-center bg-[#635bff] rounded-md px-2 py-1 mt-2">
        ...
        <div className="relative bg-gradient-to-br from-[#635bff] to-[#7a73ff] flex items-center justify-center p-8 sm:p-10 min-h-[200px] sm:min-h-[260px] overflow-hidden">
